...
export const FORWARD_RESEARCH_AO_CONFIG: ConnectArgsLegacy = { CU_URL: 'https://cu.ao-testnet.xyz', MU_URL:'https://mu.ao-testnet.xyz', MODE: 'legacy' }
...
export const AO_CONFIGURATION_DEFAULT: ConnectArgsLegacy = RANDAO_AO_CONFIG;
